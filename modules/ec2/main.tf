  ...
  resource "null_resource" "ansible-pull"{
      ...
      connection {
          ...
          inline = [
            ...
            "ansible-pull -i localhost, -U https://github.com/omkar8555/roboshop-ansible.1.git  roboshop.yml -e env=${var.env}  -e component=${var.component_name}
             -e vault-token=${var.vault_token}"
          ]
        }
    }
